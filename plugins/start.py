    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([[
                ...
                InlineKeyboardButton("❣️ Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", url="https://github.com/DX-MODS/IGDL-BOT")
                ],[
                InlineKeyboardButton("❤️‍🔥 Hᴏᴡ Tᴏ Uꜱᴇ❤️‍🔥", url="https://github.com/DX-MODS/IGDL-BOT")
                ],[
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([[
                ...
                InlineKeyboardButton("🖥️ Hᴏᴡ Tᴏ Mᴀᴋᴇ", url="https://github.com/DX-MODS/IGDL-BOT")
                ],[
                InlineKeyboardButton("🔒 Cʟᴏꜱᴇ", callback_data = "close"),
                InlineKeyboardButton("◀️ Bᴀᴄᴋ", callback_data = "start")
            ]])            
